package grabsky.configuration.tests.tests;
...
import grabsky.configuration.tests.JsonTest;
import org.junit.jupiter.api.Test;

import java.io.File;

import static grabsky.configuration.tests.util.TestUtil.getFileFromClassPath;
