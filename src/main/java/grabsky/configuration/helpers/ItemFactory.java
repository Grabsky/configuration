...
// Probably far from perfect but I'd rather keep it simple.
public final class ItemFactory {
    ...
    public static @NotNull ItemStack create(
            ...
            @Nullable final List<ItemEnchantment> enchantments,
            ...
            @Nullable final List<ItemEnchantment> enchantmentStorage,
            // Damageable Meta
